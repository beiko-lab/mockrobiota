...
qiime dada2 denoise-paired --i-demultiplexed-seqs demux_reads.qza --o-table dada2_table --o-representative-sequences representative_sequences --p-trunc-len-r 140 --p-trunc-len-f 140 --p-max-ee-f 10 --p-max-ee-r 10 --p-n-threads 4 --o-denoising-stats denoise_stats.qza --verbose
